...
sedi "s|address = \"0.0.0.0:9090\"|address = \"0.0.0.0:9190\"|" "$S0_APP"
sedi "s|address = \"0.0.0.0:9091\"|address = \"0.0.0.0:9191\"|" "$S0_APP"
...
sedi "s|address = \"0.0.0.0:9090\"|address = \"0.0.0.0:9290\"|" "$S1_APP"
sedi "s|address = \"0.0.0.0:9091\"|address = \"0.0.0.0:9291\"|" "$S1_APP"
...
sedi "s|address = \"0.0.0.0:9090\"|address = \"0.0.0.0:9390\"|" "$FN_APP"
sedi "s|address = \"0.0.0.0:9091\"|address = \"0.0.0.0:9391\"|" "$FN_APP"
...
for i in $(seq 0 $((NUM_VALIDATORS - 1))); do
  ...
  sedi "s|address = \"0.0.0.0:9090\"|address = \"127.0.0.1:${GRPC_PORT}\"|" "$VA"
