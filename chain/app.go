...
func NewExampleApp(
	...
	*/
	...
	// Custom energy-chain keepers
	app.EnergyKeeper = energykeeper.NewKeeper(appCodec, keys[energytypes.StoreKey], authAddr)
	app.OracleKeeper = oraclekeeper.NewKeeper(appCodec, keys[oracletypes.StoreKey], authAddr)
	app.IdentityKeeper = identitykeeper.NewKeeper(appCodec, keys[identitytypes.StoreKey], authAddr)
	app.AuditKeeper = auditkeeper.NewKeeper(appCodec, keys[audittypes.StoreKey], authAddr)
